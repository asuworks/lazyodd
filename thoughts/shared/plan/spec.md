# odder — ODD Protocol Generation Plugin
...
```
/odder:interview  →  research/  →  /odder:plan  →  plan/  →  /odder:draft  →  draft/  →  /odder:check  →  checked/
...
## Phase 1: `/odder:interview` (RESEARCH)
...
├── skills/
│   ├── interview/
│   │   ├── SKILL.md                 # /odder:interview
│   │   ├── odd-protocol-ref.md      # Full ODD+2 protocol (bundled)
│   │   └── odd-guidance-ref.md      # Full guidance & checklists (bundled)
│   ├── plan/
│   │   └── SKILL.md                 # /odder:plan (no ref files — reads research/)
│   ├── draft/
│   │   ├── SKILL.md                 # /odder:draft
│   │   ├── odd-protocol-ref.md      # Full ODD+2 protocol (bundled)
│   │   └── odd-guidance-ref.md      # Full guidance & checklists (bundled)
│   └── check/
│       ├── SKILL.md                 # /odder:check
│       ├── odd-protocol-ref.md      # Full ODD+2 protocol (bundled)
│       └── odd-guidance-ref.md      # Full guidance & checklists (bundled)
